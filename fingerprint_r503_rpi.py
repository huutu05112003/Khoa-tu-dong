...
uart = serial.Serial("/dev/ttyUSB0", baudrate=115200, timeout=3)
print('Bat dau thiet lap')
# If using with Linux/Raspberry Pi and hardware UART:
# uart = serial.Serial(port = '/dev/ttyS0', baudrate = 57600, parity = serial.PARITY_NONE)

# If using with Linux/Raspberry Pi 3 with pi3-disable-bt
# uart = serial.Serial("/dev/ttyAMA0", baudrate=57600, timeout=1)

finger = adafruit_fingerprint.Adafruit_Fingerprint(uart)
print('Thiet lap thanh cong')
##################################################
